...
const Hero = () => {
  return (
    <>
      <div className="hero relative w-full h-auto max-w-full flex flex-col items-center justify-start flex-nowrap overflow-hidden">
        ...
        <div className="image relative w-full flex flex-col items-center justify-center gap-6 px-6 sm:px-0">
          <Image
            src={`/hero-bg.webp`}
            alt="hero image"
            className="w-full max-w-[1300px] h-auto rounded-[53px] object-cover object-top"
            width={1300}
            height={900}
          />
        </div>
