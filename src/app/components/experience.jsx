...
const Experience = () => {
  return (
    <div id="experience" className="h-screen md:mb-[20vh] px-[30px]">
      ...
      <div className="services md:px-[2vw]">
        ...
        <div className="h-auto w-full mt-5 md:mt-10 md:pl-[10vw] lg:pl-[36vw]">
          {[
            ...
            <div
              key={index}
              className="flex flex-col gap-2 sm:gap-3 md:gap-4 md:mb-7 md:flex-row md:items-start md:justify-around lg:pb-10 appearonscroll"
            >
