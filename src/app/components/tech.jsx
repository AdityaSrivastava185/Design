          ...
          {[
            ...
            >
              ...
              <div className="max-w-[80vw] sm:max-w-[70vw] md:max-w-[50vw] mb-[50px] md:mb-[0px] lg:pb-10">
                <h2 className="text-white max-w-[40vw] md:max-w-[70vw] text-[9vw] sm:text-[4vw] md:text-[2vw] mb-[10px] md:mb-[0px] uppercase tracking-tighter leading-8 md:leading-none font-jetbrainmono lg:pb-8">
                  {phase.title}
                </h2>
